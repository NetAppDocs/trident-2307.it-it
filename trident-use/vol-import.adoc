...
[role="lead"]
È possibile importare volumi di archiviazione esistenti come PV Kubernetes utilizzando `tridentctl import` oppure creando un Persistent Volume Claim (PVC) con annotazioni di importazione Trident.
